...
class TicketServiceSpec extends Specification {
    ...
    private Long setupData() {
        ...
        //new example.Ticket(...).save(flush: true, failOnError: true)
        //new example.Ticket(...).save(flush: true, failOnError: true)
        //example.Ticket ticket = new example.Ticket(...).save(flush: true, failOnError: true)
        //new example.Ticket(...).save(flush: true, failOnError: true)
        //new example.Ticket(...).save(flush: true, failOnError: true)
