...
import example.TechnicalInspectionService
...
class TechnicalInspectionServiceSpec extends Specification {
    ...
    private Long setupData() {
        ...
        //new example.TechnicalInspection(...).save(flush: true, failOnError: true)
        //new example.TechnicalInspection(...).save(flush: true, failOnError: true)
        //example.TechnicalInspection technicalInspection = new example.TechnicalInspection(...).save(flush: true, failOnError: true)
        //new example.TechnicalInspection(...).save(flush: true, failOnError: true)
        //new example.TechnicalInspection(...).save(flush: true, failOnError: true)
