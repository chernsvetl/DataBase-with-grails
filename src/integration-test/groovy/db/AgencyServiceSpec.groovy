...
class AgencyServiceSpec extends Specification {
    ...
    private Long setupData() {
        ...
        //new example.Agency(...).save(flush: true, failOnError: true)
        //new example.Agency(...).save(flush: true, failOnError: true)
        //example.Agency agency = new example.Agency(...).save(flush: true, failOnError: true)
        //new example.Agency(...).save(flush: true, failOnError: true)
        //new example.Agency(...).save(flush: true, failOnError: true)
